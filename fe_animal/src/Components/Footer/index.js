...
const Footer = () => {
  return (
    <div className='flex flex-col text-white bg-gray-700'>
        <div className='py-5 border-b-2'>
            <Link className='text-xl mx-3' to="/">Careers</Link>
            <Link className='text-xl mx-3' to="/">Free Photos Terms</Link>
            <Link className='text-xl mx-3' to="/">Privacy</Link>
            <Link className='text-xl mx-3' to="/">About Us</Link>
        </div>
        <div className='flex justify-between px-5 border-b-2 py-10'>
            <div className='flex flex-col'>
                <Link className='font-bold' to="/">Resources</Link>
                <Link to="/">Free stock photos</Link>
                <Link to="/">Browser Free Images Collections</Link>
            </div>
            <div className='flex flex-col'>
                <Link className='font-bold' to="/">Popular Collections</Link>
