  ...
  return (
    <div className='text-white bg-gray-900 py-12'>
        <div className='flex justify-between mx-16 items-center'>
            <div>
            <h2 className="font-bold text-4xl mb-4">Browse high-resolution photo collections</h2>
            <h4>Browse high-resolution photo collections</h4>
            </div>
            <Button style={{color:"white", borderColor:"white", height: "50px"}}  variant='outlined'>View all collections</Button>
        </div>
