...
const Upload = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex gap-8 pt-3 lg:px-16 md:px-6 justify-start min-w-min">
        <div>
          <div className=" w-48 p-5 shadow-md">
            <p className="text-sm font-light">Notice</p>
            <ul className="list-disc text-sm">
              <li>the Picture will be sent to us to accept</li>
              <li>Only accepted pictures are published</li>
              <li>
                The picture after upload can not be edited, but you can delete it
              </li>
            </ul>
          </div>
        </div>
